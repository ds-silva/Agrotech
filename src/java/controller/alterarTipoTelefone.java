 ...
 * @author vinic
 */
@WebServlet(name = "alterarTipoTelefone", urlPatterns = {"/alterarTipoTelefone"})
public class alterarTipoTelefone extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                TipoTelefoneDAO.alterarTipoTelefone(t);
