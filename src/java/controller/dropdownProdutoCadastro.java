 ...
 * @author josem
 */
@WebServlet(name = "dropdownProdutoCadastro", urlPatterns = {"/dropdownProdutoCadastro"})
public class dropdownProdutoCadastro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("cadastrar_produto.jsp");
