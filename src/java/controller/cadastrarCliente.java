...
public class cadastrarCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                Cliente c = new Cliente(request.getParameter("numeroCpfCnpjUsuario"), 
                ...
                try {
                    ...
                    c.setDataEmissaoRgRne(dataEmissaoReg);
                ...
                try {
                    ...
                    c.setDataNascimento(dataNascimeReg);
                } catch (ParseException ex){
                    if (ex.getErrorOffset() == 0){
                ...
                c.setSobrenome(sobrenomeUsuario);
                c.setEmail(emailUsuario);
                
                c.setRgRne(rgRne);
                c.setOrgaoExpedidorRgRne(orgaoDocumento);;
                c.setCpfCnpj(cpfCnpjUsuario);
                c.setSexo(sexo);
                ...
                c.setStatusValidacao(null);
                
                
                //out.println(c.getCpfCnpj());
