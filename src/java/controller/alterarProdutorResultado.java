 ...
 * @author lluan
 */
@WebServlet(name = "alterarProdutorResultado", urlPatterns = {"/alterarProdutorResultado"})
public class alterarProdutorResultado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                int idProdutor = Integer.parseInt(request.getParameter("idProdutor"));
                ...
                ClienteDAO.alterarProdutor(produtor);
