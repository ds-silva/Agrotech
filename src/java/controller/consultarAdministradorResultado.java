 ...
 * @author josem
 */
@WebServlet(name = "consultarAdministradorResultado", urlPatterns = {"/consultarAdministradorResultado"})
public class consultarAdministradorResultado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher rd=request.getRequestDispatcher("resultado_cons_adm.jsp");  
