 ...
 * @author josem
 */
@WebServlet(name = "dropdownImovelRural", urlPatterns = {"/dropdownImovelRural"})
public class dropdownImovelRural extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("cadastrar_ir.jsp");
