 ...
 * @author josem
 */
@WebServlet(name = "consultarTipoTelefone", urlPatterns = {"/consultarTipoTelefone"})
public class consultarTipoTelefone extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                if (!"".equals(request.getParameter("tipoTelefone"))) {
