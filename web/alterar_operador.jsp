            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Alterar Operador</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="consultar_operador.jsp">Consultar Operador</a></li>
                            <li class="breadcrumb-item"><a href="li_consulta_operador.jsp">Listagem de Consulta</a></li>
                            <li class="breadcrumb-item"><a href="resultado_cons_operador.jsp">Resultado Consulta</a></li>
                            <li class="breadcrumb-item active">Alterar Operador</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form action="#" method="#">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                 <%
                                                    Operador op = (Operador) request.getAttribute("op");
                                                %>
                                                <label class="small mb-1" for="nomeUsuario">Nome</label>
                                                <input class="form-control py-3" id="idUsuario" name="idUsuario" type="hidden" placeholder="" value="<%=op.getIdUsuario()%>" disabled/>
                                                <input class="form-control py-3" id="nomeUsuario" name="nomeUsuario" type="text" placeholder="Digite seu nome" value="<%=op.getNome()%>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="sobrenomeUsuario" name="sobrenomeUsuario" type="text" placeholder="Digite seu sobrenome" value="<%=op.getSobrenome()%>"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="emailUsuario" name="emailUsuario" type="text" placeholder="Digite seu email" value="<%=op.getEmail()%>" />
                                            </div>   
                                        </div>
                                        ...
                                        <div class="col-md-2">    
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="matriculaUsuario" name="matriculaUsuario" type="text" placeholder="Apenas números" onkeypress="return apenasNumeros(event);" onblur="maxLength()" value="<%=op.getMatricula()%>"/>
                                            </div>                                 
                                         </div>
                                         ...
                                         <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select id="situacaoUsuario" name="situacaoUsuario" class="form-control">
                                                    <option value="<%=op.getIdSituacaoUsuario()%>"><%=op.getDescSituacaoUsuario()%></option>
                                        ...
                                        <div class="col-md-6" >
                                            <div class="form-group">                                            
                                                ...
                                                <select id="tipoUsuario" name="tipoUsuario" class="form-control">
                                                    <option value="<%=op.getTipoUsuario().getIdTipoUsuario()%>"><%=op.getTipoUsuario().getTipoUsuario()%></option>
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3 " id="naturalizacaoDocumento" name="naturalizacaoDocumento" type="text" value="<%=op.getRgRne()%>" placeholder="Digite o documento"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="orgaoDocumento" name="orgaoDocumento" type="text" placeholder="Digite o órgão" value="<%=op.getOrgaoExpedidorRgRne()%>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="emissaoDocumento" name="emissaoDocumento" type="text" placeholder="dd/mm/aaaa" value="<%=fUS.format(op.getDataEmissaoRgRne())%>" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row"> 
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3 " id="numeroCpfCnpjUsuario" name="numeroCpfCnpjUsuario" type="text" value="<%=op.getCpfCnpj()%>" placeholder="Digite o documento"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group" Style="height: 38px;">                                            
                                                ...
                                                <select id="sexo" name="sexo" class="form-control">
                                                    <option value="<%=op.getSexo()%>"><%=op.getSexo()%></option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="nascimentoUsuario" name="nascimentoUsuario" type="text" placeholder="dd/mm/aaaa" onblur="Is18()" value="<%=fUS.format(op.getDataNascimento())%>" />
                                            </div>
                                        </div> 
                                    </div>
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">                                            
                                                ...
                                                <select id="nacionalidadeUsuario" name="nacionalidadeUsuario" class="form-control">
                                                    <option value="<%=op.getNacionalidade().getIdNacionalidade()%>"><%=op.getNacionalidade().getDescricaoNacionalidade()%></option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group" >                                            
                                                ...
                                                <select id="orgaoFuncional" name="orgaoFuncional" class="form-control">
                                                    <option value="<%=op.getRegional().getIdOrgaoFuncional()%>"><%=op.getRegional().getOrgaoFuncional()%></option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <option value="<%=op.getRegional().getIdRegional()%>"><%=op.getRegional().getDescricaoRegional()%></option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row"><div class="col-md-3"></div><h5 class="font-weight-light my-4">Contatos</h5></div>
                                     ...
                                     <%  
                                        Telefone t1 = null;
                                        if (op.getTelefones().size()<1) {
                                            t1 = new Telefone();
                                        } else {
                                            t1 = op.getTelefones().get(0);
                                        }
                                    %>
                                    <div class="form-row">
                                        <div class="col-md-3">    </div>
                                    ...
                                    <%  
                                        Telefone t2 = null;
                                        if (op.getTelefones().size()<2) {
                                            t2 = new Telefone();
                                        } else {
                                            t2 = op.getTelefones().get(1);
                                        }
                                    %>
                                    <div class="form-row">
                                        <div class="col-md-3">    </div>
                                    ...
                                    <%  
                                        Telefone t3 = null;
                                        if (op.getTelefones().size()<3) {
                                            t3 = new Telefone();
                                        } else {
                                            t3 = op.getTelefones().get(2);
                                        }
                                    %>
                                    <div class="form-row">
                                        <div class="col-md-3">    </div>
                                    ...
                                    <%  
                                        Telefone t4 = null;
                                        if (op.getTelefones().size()<4) {
                                            t4 = new Telefone();
                                        } else {
                                            t4 = op.getTelefones().get(3);
                                        }
                                    %>
                                    <div class="form-row">
                                        <div class="col-md-3">    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="cep" name="cep" type="text" value="<%=op.getEndereco().getCep()%>" onblur="pesquisacep(this.value);" placeholder="Digite o CEP"/>
                                            </div>
                                        </div>
                                        ...
                                        <div hidden class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="idEndereco" name="idEndereco" type="hidden" placeholder="Tipo de logradouro" value="<%=op.getEndereco().getIdEndereco()%>" />
                                                
                                                <input class="form-control py-3" id="tipoLogradouro" name="tipoLogradouro" type="text" placeholder="Tipo de logradouro" value="<%=op.getEndereco().getTipoLogradouro()%>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="logradouro" name="logradouro" type="text" placeholder="Nome logradouro" value="<%=op.getEndereco().getLogradouro()%>" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="numeroEndereco" name="numeroEndereco" type="text" placeholder="Nº do local" value="<%=op.getEndereco().getNumero()%>" />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label class="small mb-1" for="complemento">Complemento</label>
                                                <input class="form-control py-3" id="complemento" name="complemento" type="text" placeholder="Complemento" value="<%=op.getEndereco().getComplemento()%>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="bairro" name="bairro" type="text" placeholder="Bairro" value="<%=op.getEndereco().getBairro()%>"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="cidade" name="cidade" type="text" placeholder="Cidade" onkeypress="return apenasLetras(event);" value="<%=op.getEndereco().getCidade()%>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="estado" name="estado" class="form-control">
                                                <option value="<%=op.getEndereco().getEstado().getIdEstado()%>"><%=op.getEndereco().getEstado().getDescricaoEstado()%></option>
