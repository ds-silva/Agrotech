        ...
        <script>
              $(document).ready(function(){
                  $("#excluir").click(function(){
                      ...
                      var _idSituacaoUsuario = $("#idSituacaoUsuario").val();
                      
                      $.ajax(
                          {
                              url:"excluirSituacaoUsuario?"+
                                  "idSituacaoUsuario="+_idSituacaoUsuario,
          ...
          <script>
                 $(document).ready(function(){
                  $("#desabilitar").click(function(){
                      ...
                      $.ajax(
                          {
                              url:"desabilitarSituacaoUsuario?"+
                                  "idSituacaoUsuario="+_idSituacaoUsuario,
                              contentType: "charset=UTF-8",
                              success: function(retorno){
                                  if (retorno.trim()=="ok") {
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Resultado de Consulta de Situação de Usuário</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="consultar_sit.jsp">Consultar</a></li>
                        <li class="breadcrumb-item"><a href="li_consulta_sit.jsp">Listagem de Consulta</a></li>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="resultadoConsSit" method="post">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <%
                                                Usuario u = (Usuario) request.getAttribute("situacaoUsuario");
                                            %>      
                                            <input class="form-control py-3" id="idSituacaoUsuario" name="idSituacaoUsuario" type="hidden" placeholder="" value="<%=u.getIdSituacaoUsuario()%>" disabled/>
                                            <input class="form-control py-3" id="desabilitarImovelRural" name="desabilitarImovelRural" type="hidden" placeholder="" value="<%=u.getDesabilitardescSituacaoUsuario()%>" disabled/>
                                            <input class="form-control py-3" id="situacaoUsuario" name="situacaoUsuario" type="text" placeholder="" value="<%=u.getDescSituacaoUsuario()%>" disabled/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <div class="form-group mt-4 mb-0"><a href="alterarSit?id=<%=u.getIdSituacaoUsuario()%>" class="btn btn-warning btn-block text-light" role="button">Alterar</a></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <%
                                                            if (u.getDesabilitardescSituacaoUsuario() == true) {
                                                        %>
                                        ...
                                        <div class="modal-content">
                                            <form>
                                                <div class="modal-header">						
                                                    <h4 class="modal-title">Excluir Situação de Usuário</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                </div>
                                                <div class="modal-body">					
                                                    <p>Tem certeza que deseja <strong>apagar</strong> essa situação de usuário?</p>
                                ...
                                <div id="DisableEmployeeModal" class="modal fade">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form>
                                                <div class="modal-header">						
                                                    <h4 class="modal-title">Desabilitar Situação de Usuário</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                </div>
                                                <div class="modal-body">					
                                                    <p>Tem certeza que deseja <strong>desabilitar</strong> essa situação de usuário?</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">Cancelar</button>
                                                    <%
