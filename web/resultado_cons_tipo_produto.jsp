        ...
        <script>
            $(document).ready(function() {
                $("#excluir").click(function() {
                    ...
                    var idTipoProduto = $("#idTipoProduto").val();

                    $.ajax(
                        {
                            url: "excluirTipoProduto?"+
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Resultado de Consulta de Tipo de Produto</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="consultar_tipo_produto.jsp">Consultar</a></li>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form action="resultadoConsTipoProduto" method="post">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="small mb-1.1" for="tipoProduto">Tipo de Produto</label>
                                                  <%
                                                    DescricaoProduto dp = (DescricaoProduto) request.getAttribute("tipoProduto");
                                                %>
                                                <input class="form-control py-3" id="idTipoProduto" name="idTipoProduto" type="hidden" placeholder="" value="<%=dp.getIdTipoProduto()%>" disabled/>
                                                <input class="form-control py-3" id="DesabilitarTipoProduto" name="DesabilitarTipoProduto" type="hidden" placeholder="" value="<%=dp.getDesabilitarTipoProduto()%>" disabled/>
                                                <input class="form-control py-3" id="tipoProduto" name="tipoProduto" type="text" placeholder="" value="<%=dp.getTipoProduto()%>" disabled/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="form-group mt-4 mb-0"><a href="alterarTipoProduto?id=<%=dp.getIdTipoProduto()%>" class="btn btn-warning btn-block text-light" role="button">Alterar</a></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-content">
                                            <form>
                                                ...
                                                <div class="modal-body">					
                                                    <p>Tem certeza que deseja <strong>apagar</strong> esse tipo de produto?</p>
