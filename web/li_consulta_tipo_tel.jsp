...
<html>
    <head>
        ...
        <title>Listagem de Consulta de Tipo de Telefone</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Listagem de Consultar Tipo de Telefone</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="consultar_tipo_tel.jsp">Consulta</a></li>
                                        ...
                                        <div class="table-title">
                                            <div class="row">
                                                ...
                                                <table class="table table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                    <%
                                                    List<Telefone> tiposTelefone=(ArrayList<Telefone>) session.getAttribute("listaTiposTelefone"); 
                                                    for (Telefone t: tiposTelefone) {   
                                                    %>
                                                        <tr data-href="#">
                                                            <td><a href="consultarTipoTelefoneResultado?id=<%=t.getIdTipoTelefone()%>"><%=t.getTipoTelefone()%></a></td>
                                                            <td><a href="consultarTipoTelefoneResultado?id=<%=t.getIdTipoTelefone()%>">
                                                                    <%
                                    ...
                                    <div id="deleteEmployeeModal" class="modal fade">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form>
                                                    <div class="modal-header">						
                                                        <h4 class="modal-title">Deletar Tipo de Telefone</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                    </div>
                                                    <div class="modal-body">					
