            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Resultado de Consulta de Proprietário</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="consultar_proprietario.jsp">Consultar</a></li>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form action="resultadoConsUsu" method="post">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                %>
                                                <input class="form-control py-3" id="idProprietario" name="idProprietario" type="hidden" placeholder="Digite seu Nome" value="<%=proprietario.getIdUsuario()%>" disabled/>
                                                <input class="form-control py-3" id="nomeUsuario" name="nomeUsuario" type="text" placeholder="Digite seu Nome" value="<%=proprietario.getNome()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="sobrenomeUsuario" name="sobrenomeUsuario" type="text" placeholder="Digite seu Sobrenome" value="<%=proprietario.getSobrenome()%>" disabled/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="emailUsuario" name="emailUsuario" type="email" placeholder="Digite seu Email" value="<%=proprietario.getEmail()%>" disabled/>
                                            </div>   
                                        </div>
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3 " id="naturalizacaoDocumento" name="naturalizacaoDocumento" type="text" value="<%=proprietario.getRgRne()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="orgaoDocumento" name="orgaoDocumento" type="text" placeholder="" value="<%=proprietario.getOrgaoExpedidorRgRne()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="emissaoDocumento" name="emissaoDocumento" type="date" placeholder="dd/mm/aaaa" value="<%=proprietario.getDataEmissaoRgRne()%>" disabled/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row"> 
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3 " id="numeroCpfCnpjUsuario" name="numeroCpfCnpjUsuario" type="text" value="<%=proprietario.getCpfCnpj()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group" Style="height: 38px;">                                            
                                                ...
                                                <select id="sexo" name="sexo" class="form-control" disabled>
                                                    <option value=""><%=proprietario.getSexo()%></option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="nascimentoUsuario" name="nascimentoUsuario" type="date" placeholder="dd/mm/aaaa" value="<%=proprietario.getDataNascimento()%>" disabled/>
                                            </div>
                                        </div> 
                                    </div>
                                    ...
                                    <%
                                        for (Telefone t : proprietario.getTelefones()) {
                                    %>
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="cep" name="cep" type="text" onblur="pesquisacep(this.value);" value="<%=proprietario.getEndereco().getCep()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="tipoLogradouro" name="tipoLogradouro" type="text" placeholder="Tipo de Logradouro" value="<%=proprietario.getEndereco().getTipoLogradouro()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="logradouro" name="logradouro" type="text" placeholder="Nome do Logradouro" value="<%=proprietario.getEndereco().getLogradouro()%>" disabled/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="numeroEndereco" name="numeroEndereco" type="text" placeholder="Nº do Local" value="<%=proprietario.getEndereco().getNumero()%>" disabled/>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label class="small mb-1" for="complemento">Complemento</label>
                                                <input class="form-control py-3" id="complemento" name="complemento" type="text" placeholder="Complemento" value="<%=proprietario.getEndereco().getComplemento()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="bairro" name="bairro" type="text" placeholder="Bairro" value="<%=proprietario.getEndereco().getBairro()%>" disabled/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="cidade" name="cidade" type="text" placeholder="Cidade" value="<%=proprietario.getEndereco().getCidade()%>" disabled/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="form-group mt-4 mb-0"><a href="alterarProprietarioResultado?id=<%=proprietario.getIdUsuario()%>"><button class="btn btn-warning btn-block text-light">Alterar</button></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <%
                                                    if (proprietario.getDesabilitarUsuario() == true) {
                                                %>
