    ...
    <body>
            ...
            <div class="card text-center">
                ...
                <div class="container">
                    <div class="card-body">
                        ...
                        <h4 class="card-title display-5">AGRONEGÓCIO NO BRASIL</h4>
    
                        <div class="row" style="margin-top: 5%;">
                        
                            <div class="col-12">
                                <h6 class="text-justify lead" style="font-size: 20px; margin-top: 2%;">
                                Agronegócio é uma grande cadeia produtiva. Engloba agroindústrias, fabricação de máquinas,
                                equipamentos agrícolas, indústrias químicas, setor financeiro, etc. Integrando o espaço rural
                                ao espaço urbano de grandes cidades.

                                </h6>
                            </div>
    
                            <div class="col-12">
                                <div style="margin-top: 5%;"><img src="img/mercado.png" class="img-fluid" alt="Responsive image"></div>
                            </div>
    
                            <div class="col-12">
                                <h6 class="text-justify lead" style="font-size: 20px; margin-top: 5%;">
                                  Sendo o país o maior produtor em potencial de alimentos do mundo, no Brasil o agronegócio desempenha um
                                  forte papel na economia brasileira representando cerca de 23% do PIB nacional nos últimos 2 anos.
                                  É importante também para as exportações, representando mais de 40%. Sendo o Brasil o segundo maior exportador de soja,
                                  além de exportar em grande quantidade outros produtos, que estão entre os 10 mais exportados, como: celulose, carne de frango,
                                  milho em grãos, carne bovina e café em grão.

                                </h6>
                            </div>
    
                            <div class="col-12">
                                <div style="margin-top: 5%;"><img src="img/soja.png" class="img-fluid" alt="Responsive image"></div>
                            </div>                        
        ...
        <div style="background-color: #28a745;">
            <div class="w-100 p-3 container" >
                ...
                <script src="js/jquery.mask.min.js"></script>
                <script src="js/buscadorcep.js" type="text/javascript"></script>
    </body>
