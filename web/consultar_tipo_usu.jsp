...
<html lang="pt-br">
    <head>
        ...
        <title>Consultar Tipo de Usuário</title>
        ...
        <script>
            $(document).ready(function(){
                $("#consultar").click(function(){
                    ...
                    var tipoDeUsuario = $("#tipoUsuario").val();
                    
                    $.ajax(
                        {
                            url:"consultarTipoUsu?"+
                                "tipoUsuario="+tipoDeUsuario,
                            contentType: "charset=UTF-8",
                            success: function(retorno){
                                if (retorno=="ok") {
                                  location.replace("li_consulta_tipo_usu.jsp");  //sucesso  //successo
                                } else{
                                    //erro
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Consultar Tipo de Usuário</h1>
