            ...
            $(document).ready(function() {
                $("#cadastrar").click(function() {
                   event.preventDefault();
                    ...
                    var _confirmaSenha = $("#confirmaSenha").val();
                    var _naturalizacaoDocumento = $("#naturalizacaoDocumento").val();
                    var _orgaoDocumento = $("#orgaoDocumento").val();
                    var _emissaoDocumento = $("#emissaoDocumento").val();
                    var _numeroCpfCnpjUsuario = $("#numeroCpfCnpjUsuario").val();
                    var _sexo = $("#sexo").val();
                    var _nascimentoUsuario = $("#nascimentoUsuario").val();
                    var _tipoUsuario = $("#tipoUsuario").val();
                    var _nacionalidadeUsuario = $("#nacionalidadeUsuario").val();
                    var _orgaoFuncional = $("#orgaoFuncional").val();
                    var _regional = $("#regional").val();
                    var _tipoTelefone1 = $("#tipoTelefone1").val();
                    var _telefone1 = $("#telefone1").val();
                    var _tipoTelefone2 = $("#tipoTelefone2").val();
                    var _telefone2 = $("#telefone2").val();
                    var _tipoTelefone3 = $("#tipoTelefone3").val();
                    var _telefone3 = $("#telefone3").val();
                    var _tipoTelefone4 = $("#tipoTelefone4").val();
                    var _telefone4 = $("#telefone4").val();
                    var _cep = $("#cep").val();
                    var _tipoLogradouro = $("#tipoLogradouro").val();
                    var _logradouro = $("#logradouro").val();
                    var _numeroEndereco = $("#numeroEndereco").val();
                    ...
                    $.ajax(
                        {
                            ...
                            "&orgaoDocumento="+_orgaoDocumento+
                            "&emissaoDocumento="+_emissaoDocumento+
                            "&numeroCpfCnpjUsuario="+_numeroCpfCnpjUsuario+
                            "&sexo="+_sexo+
                            "&nascimentoUsuario="+_nascimentoUsuario+
                            "&tipoUsuario="+_tipoUsuario+
                            "&nacionalidadeUsuario="+_nacionalidadeUsuario+
                            "&orgaoFuncional="+_orgaoFuncional+
                            "&regional="+_regional+
                            "&tipoTelefone1="+_tipoTelefone1+
                            "&telefone1="+_telefone1+
                            "&tipoTelefone2="+_tipoTelefone2+
                            "&telefone2="+_telefone2+
                            "&tipoTelefone3="+_tipoTelefone3+
                            "&telefone3="+_telefone3+
                            "&tipoTelefone4="+_tipoTelefone4+
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Cadastrar de Operador</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item active">Cadastrar Operador</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-2">    
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="matriculaUsuario" name="matriculaUsuario" type="text" placeholder="Apenas números" onkeypress="return apenasNumeros(event);" maxlength="7" onblur="maxLenght()" value=""/>
                                            </div>                                 
                                         </div>
                                         <div class="col-md-3">    </div>
                                    </div>
