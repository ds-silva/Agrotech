...
<html>
    <head>
        ...
        <title>Listagem de Consulta de Produto</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Listagem de Consultar Produto</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="consultar_produto.jsp">Consulta</a></li>
                                ...
                                <div class="container">
                                    <div class="table-wrapper">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                             <%
                                                    List<Produto> produto=(ArrayList<Produto>) session.getAttribute("listaProdutos"); 
                                                    for (Produto p: produto) {   
                                            %>
                                                 <tr data-href="#">
                                                    <td><a href="consultarProdutoResultado?id=<%=p.getIdProduto()%>"><%=p.getDescricaoProduto().getDescricaoProduto() %></a></td>
                                                    <td><a href="consultarProdutoResultado?id=<%=p.getIdProduto()%>"><%=p.getDescricaoProduto().getTipoProduto() %></a></td>
                                                    <td><a href="consultarProdutoResultado?id=<%=p.getIdProduto()%>"><%=p.getAno() %></a></td>
                                                    <td><a href="consultarProdutoResultado?id=<%=p.getIdProduto()%>"><%=p.getMesSafra() %></a></td>
                                                    <td><a href="consultarProdutoResultado?id=<%=p.getIdProduto()%>">
                                                            <%
