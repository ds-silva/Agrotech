...
<html lang="pt-br">
    <head>
        ...
        <title>Consultar Tipo de Telefone</title>
        ...
        <script>
            $(document).ready(function() {
                $("#consultar").click(function() {
                    ...
                    var tipoTelefone_digitado = $("#tipoTelefone").val();
                    
                    $.ajax(
                        {
                            url: "consultarTipoTelefone?"+
                            "tipoTelefone="+tipoTelefone_digitado,
                            contentType: "charset=UTF-8",
                            success: function(retorno) {
                                if (retorno=="ok") {
                                   location.replace("li_consulta_tipo_tel.jsp");  //sucesso //sucesso
                                    } 
                                    else {
                                        //erro
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Consultar Tipo de Telefone</h1>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="tipoTelefone" name="tipoTelefone" type="text" placeholder="Digite o tipo" />
                                            </div>
                                        </div>
