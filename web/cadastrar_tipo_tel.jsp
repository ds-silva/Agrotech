...
<html lang="pt-br">
    <head>
        ...
        <title>Cadastrar Tipo de Telefone </title>
        ...
        <script>
            $(document).ready(function() {
                $("#cadastrar").click(function() {
                    ...
                    var cadastrarTipoTelefone = $("#tipoTelefone").val();
                    

                    $.ajax(
                        {
                            url: "cadastrarTipoTelefone?"+
                            "tipoTelefone="+cadastrarTipoTelefone,
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Cadastrar Tipo de Telefone </h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Cadastrar Tipo de Telefone </li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="tipoTelefone" name="tipoTelefone" type="text" placeholder="Digite o tipo" value="" />
                                            </div>
                                        </div>
