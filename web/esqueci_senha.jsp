    ...
    <body>
        ...
        <div class="card mb-4 mt-4">
            <div class="card-body">
                ...
                <h3 class="text-center font-weight-light mt-2 my-0">Recuperação de senha</h3>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-lg-5 py-0.5">
                                            ...
                                            <div class="form-group mt-4">
                                                <p>Digite seu endereço de e-mail e enviaremos um link para redefinir<br> sua senha.</p>
                                                <label class=" mb-2" for="emailUsuario">E-mail</label>
                                                <input class="form-control py-4" id="emailUsuario" name="emailUsuario" type="email" placeholder="Digite a seu email"/>
                                            </div>
                                            <p class="small">Caso não possua email, procure o posto em que realizou o cadastro para redefinir<br> sua senha.</p>
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small text-success" href="login.jsp">Voltar</a>
                                            ...
                                            <div class="text-center">
                                                <div class="small mt-4"><a class="text-success" href="cadastro_proprietario.jsp">Não possui conta? Cadastre-se!</a></div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      ...
                                      <div class="modal-body py-5">    
                                        <h6 class="text-danger text-center"> 
                                            <div class="" id="mostrarsucesso"><h4>Seu email foi enviado com sucesso.<br> Cheque sua caixa de entrada</h4></div>
                                        </h6>
                                      </div>
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-dark" data-dismiss="modal">Fechar</button>
