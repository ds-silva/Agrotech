...
<html lang="pt-br">
    <head>
        ...
        <title>Cadastrar Situação de Usuário</title>
        ...
        <script>
            $(document).ready(function(){
                $("#cadastrar").click(function(){
                    ...
                    var situacao = $("#situacaoUsuario").val();
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Cadastrar Situação de Usuário</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item active">Cadastrar Situação de Usuário</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="situacaoUsuario" name="situacaoUsuario" type="text" placeholder="Digite a situação" value=""/>
                                            </div>
                                        </div>
