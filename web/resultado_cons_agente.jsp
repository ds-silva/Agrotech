        ...
        <script>
            $(document).ready(function () {
                $("#excluir").click(function () {
                    ...
                    var idExcluirAgente = $("#idAgente").val();

                    $.ajax(
                            {
                                url: "excluirAgente?" +
                                        "idAgente=" + idExcluirAgente,
        ...
        <script>
            $(document).ready(function () {
                $("#desabilitar").click(function () {
                    ...
                    var idDesabilitarAgente = $("#idAgente").val();

                    $.ajax(
                            {
                                url: "desabilitarAgente?" +
                                        "idAgente=" + idDesabilitarAgente,
                                contentType: "charset=UTF-8",
                                success: function (retorno) {
                                    if (retorno.trim() == "ok") {
                                        //sucesso
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Resultado de Consulta de Agente</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="consultar_agente.jsp">Consultar</a></li>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="resultadoConsUsu" method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            %>
                                            <input class="form-control py-3" id="idAgente" name="idAgente" type="hidden" placeholder="Digite seu Nome" value="<%=agt.getIdUsuario()%>" disabled/>
                                            <input class="form-control py-3" id="nomeUsuario" name="nomeUsuario" type="text" placeholder="Digite seu Nome" value="<%=agt.getNome()%>" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="sobrenomeUsuario" name="sobrenomeUsuario" type="text" placeholder="Digite seu Sobrenome" value="<%=agt.getSobrenome()%>" disabled/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">    
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="emailUsuario" name="emailUsuario" type="email" placeholder="Digite seu Email" value="<%=agt.getEmail()%>" disabled/>
                                        </div>   
                                    </div>
                                    ...
                                    <div class="col-md-2">    
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="matriculaUsuario" name="matriculaUsuario" type="text" placeholder="Apenas Números" value="<%=agt.getMatricula()%>" disabled/>
                                        </div>                                 
                                    </div>
                                    <div class="col-md-3">    </div>
                                </div>
                                ...
                                <div class="form-row">    
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3 " id="naturalizacaoDocumento" name="naturalizacaoDocumento" type="text" value="<%=agt.getRgRne()%>" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="orgaoDocumento" name="orgaoDocumento" type="text" placeholder="" value="<%=agt.getOrgaoExpedidorRgRne()%>" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="emissaoDocumento" name="emissaoDocumento" type="date" placeholder="dd/mm/aaaa" value="<%=agt.getDataEmissaoRgRne()%>" disabled/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row"> 
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3 " id="numeroCpfCnpjUsuario" name="numeroCpfCnpjUsuario" type="text" value="<%=agt.getCpfCnpj()%>" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group" Style="height: 38px;">                                            
                                            ...
                                            <select id="sexo" name="sexo" class="form-control" disabled>
                                                <option value=""><%=agt.getSexo()%></option>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="nascimentoUsuario" name="nascimentoUsuario" type="date" placeholder="dd/mm/aaaa" value="<%=agt.getDataNascimento()%>" disabled/>
                                        </div>
                                    </div> 
                                </div>
                                ...
                                <div class="form-row">    
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="regional" name="regional" type="text" placeholder="Regional" value="<%=agt.getRegional().getDescricaoRegional()%>" disabled/>
                                        </div>
                                    </div>
                                ...
                                <%
                                    for (Telefone tel : agt.getTelefones()) {
                                %>
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select id="tipoTelefone1" name="tipoTelefone1" class="form-control" disabled>
                                                <option value="<%=tel.getIdTipoTelefone()%>"><%=tel.getTipoTelefone()%></option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="telefone1" name="telefone1" type="text" placeholder="Telefone" value="<%=tel.getNumeroTelefone()%>" disabled/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="cep" name="cep" type="text" onblur="pesquisacep(this.value);" value="<%=agt.getEndereco().getCep()%>" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="tipoLogradouro" name="tipoLogradouro" type="text" placeholder="Tipo de Logradouro" value="<%=agt.getEndereco().getTipoLogradouro()%>" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="logradouro" name="logradouro" type="text" placeholder="Nome do Logradouro" value="<%=agt.getEndereco().getLogradouro()%>" disabled/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="numeroEndereco" name="numeroEndereco" type="text" placeholder="Nº do Local" value="<%=agt.getEndereco().getNumero()%>" disabled/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="small mb-1" for="complemento">Complemento</label>
                                            <input class="form-control py-3" id="complemento" name="complemento" type="text" placeholder="Complemento" value="<%=agt.getEndereco().getComplemento()%>" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="bairro" name="bairro" type="text" placeholder="Bairro" value="<%=agt.getEndereco().getBairro()%>" disabled/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">    
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="cidade" name="cidade" type="text" placeholder="Cidade" value="<%=agt.getEndereco().getCidade()%>" disabled/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <div class="form-group mt-4 mb-0"><a href="alterarAgente?id=<%=agt.getIdUsuario()%>" class="btn btn-warning btn-block text-light" role="button">Alterar</a></div>
                                        </div>
                                    </div>
