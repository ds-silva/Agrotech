        ...
        <script>
            $(document).ready(function () {
                $("#salvarAlteracoes").click(function () {
                    ...
                    var confirmarSenha_digitado = $("#confirmarSenha").val();
                    ...
                    $.ajax(
                            {
                                url: "alterarProdutorResultado?" +
                                        ...
                                        "&confirmarSenha=" + confirmarSenha_digitado +
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Alterar Produtor</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="consultar_produtor.jsp">Consultar Produtor</a></li>
                        <li class="breadcrumb-item"><a href="li_consulta_produtor.jsp">Listagem de Consulta</a></li>
                        <li class="breadcrumb-item"><a href="resultado_cons_produtor.jsp">Resultado Consulta</a></li>
                        <li class="breadcrumb-item active">Alterar Produtor</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="#" method="#">
                                ...
                                <div class="form-row">
                                    <%                                             
                                        Produtor p = (Produtor) request.getAttribute("alterarProdutor");
                                    %>
                                    <div class="col-md-3">    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="idProdutor" name="idProdutor" type="hidden" placeholder="Digite o tipo" value="<%=p.getIdUsuario()%>" />
                                            <input class="form-control py-3" id="nomeUsuario" name="nomeUsuario" type="text" placeholder="Digite seu nome" value="<%=p.getNome()%>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="sobrenomeUsuario" name="sobrenomeUsuario" type="text" placeholder="Digite seu sobrenome" value="<%=p.getSobrenome()%>"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">    
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="emailUsuario" name="emailUsuario" type="email" placeholder="Digite seu email" value="<%=p.getEmail()%>"/>
                                        </div>   
                                    </div>
                                ...
                                <div class="form-row">    
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3 " id="naturalizacaoDocumento" name="naturalizacaoDocumento" type="text" value="<%=p.getRgRne()%>" placeholder="Digite o documento"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="orgaoDocumento" name="orgaoDocumento" type="text" placeholder="Digite o órgão" value="<%=p.getOrgaoExpedidorRgRne()%>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="emissaoDocumento" name="emissaoDocumento" type="text" placeholder="dd/mm/aaaa" value="<%=fUS.format(p.getDataNascimento())%>" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row"> 
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3 " id="numeroCpfCnpjUsuario" name="numeroCpfCnpjUsuario" type="text" value="<%=p.getCpfCnpj()%>" placeholder="Digite o documento"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group" Style="height: 38px;">                                            
                                            ...
                                            <select id="sexo" name="sexo" class="form-control">
                                                <option value="<%=p.getSexo()%>"><%=p.getSexo()%></option>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="nascimentoUsuario" name="nascimentoUsuario" type="text" placeholder="dd/mm/aaaa"  onblur="Is18()" value="<%=fUS.format(p.getDataNascimento())%>" />
                                        </div>
                                    </div> 
                                </div>
                                ...
                                <%  
                                    ...
                                    <%  
                                        Telefone t2 = null;
                                        if (p.getTelefones().size()<2) {
                                            t2 = new Telefone();
                                        } else {
                                            t2 = p.getTelefones().get(1);
                                        }
                                    %>
                                    <div class="form-row">
                                        <div class="col-md-3">    </div>
                                    ...
                                    <%  
                                        Telefone t3 = null;
                                        if (p.getTelefones().size()<3) {
                                            t3 = new Telefone();
                                        } else {
                                            t3 = p.getTelefones().get(2);
                                        }
                                    %>
                                    <div class="form-row">
                                        <div class="col-md-3">    </div>
                                    ...
                                    <%  
                                        Telefone t4 = null;
                                        if (p.getTelefones().size()<4) {
                                            t4 = new Telefone();
                                        } else {
                                            t4 = p.getTelefones().get(3);
                                        }
                                    %>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="idEndereco" name="idEndereco" type="hidden" placeholder="" value="<%=p.getEndereco().getIdEndereco()%>" />
                                            <input class="form-control py-3" id="cep" name="cep" type="text" onblur="pesquisacep(this.value);" value="<%=p.getEndereco().getCep()%>" placeholder="Digite o CEP"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2" hidden>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="tipoLogradouro" name="tipoLogradouro" type="text" placeholder="Tipo de logradouro" value="<%=p.getEndereco().getTipoLogradouro()%>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="logradouro" name="logradouro" type="text" placeholder="Nome logradouro" value="<%=p.getEndereco().getLogradouro()%>"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="numeroEndereco" name="numeroEndereco" type="text" placeholder="Nº do local" value="<%=p.getEndereco().getNumero()%>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="small mb-1" for="complemento">Complemento</label>
                                            <input class="form-control py-3" id="complemento" name="complemento" type="text" placeholder="Complemento" value="<%=p.getEndereco().getComplemento()%>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="bairro" name="bairro" type="text" placeholder="Bairro" value="<%=p.getEndereco().getBairro()%>"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">    
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="cidade" name="cidade" type="text" placeholder="Cidade" onkeypress="return apenasLetras(event);" value="<%=p.getEndereco().getCidade()%>"/>
                                        </div>
                                    </div>
