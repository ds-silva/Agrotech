...
<html lang="pt-br">
    <head>
        ...
        <title>Alterar Descrição de Produto</title>
        ...
        <script>
            $(document).ready(function () {
                $("#salvarAlteracoes").click(function () {
                    ...
                    var unidade_produto = $("#unidadeProduto").val();
                    var id_descricao_produto = $("#idDescricaoProduto").val();

                    $.ajax(
                            {
                                url: "alterarDescricaoProdutoResultado?" +
                                        "tipoProduto=" + tipo_produto +
                                        "&nomeProduto=" + nome_produto +
                                        "&unidadeProduto=" + unidade_produto +
                                        "&idDescricaoProduto=" + id_descricao_produto,
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Alterar Descrição de Produtos</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="consultar_desc_produto.jsp">Consultar Descrição de Produtos</a></li>
                        <li class="breadcrumb-item"><a href="li_consulta_desc_produto.jsp">Listagem de Consulta</a></li>
                        <li class="breadcrumb-item"><a href="resultado_cons_desc_produto.jsp">Resultado Consulta</a></li>
                        <li class="breadcrumb-item active">Alterar Descrição de Produtos</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-body">
                                ...
                                <div class="form-row">  
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" id="idDescricaoProduto" name="idDescricaoProduto" type="hidden" placeholder="" value="<%=dP.getIdDescricaoProduto()%>" disabled />
                                            <input class="form-control py-3" name="nomeProduto" id="nomeProduto" type="text" placeholder="Digite o produto" value="<%=dP.getDescricaoProduto()%>"/>                                          
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-3" name="unidadeProduto" id="unidadeProduto" type="text" placeholder="Digite a unidade" value="<%=dP.getUnidadeProduto()%>"/>
                                        </div>
                                    </div>
                                </div>
