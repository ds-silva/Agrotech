                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="quantidadeProduzida" name="quantidadeProduzida" type="text" placeholder="Digite o número da produção" onkeypress="return apenasNumeros(event);" value="" />
                                            </div>
                                        </div> 
