                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="consultar_estado.jsp">Consultar Estado</a></li>
                            <li class="breadcrumb-item"><a href="li_consulta_estado.jsp">Listagem de Consulta</a></li>
                            <li class="breadcrumb-item"><a href="resultado_cons_estado.jsp">Resultado Consulta</a></li>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                %>
                                                <input class="form-control py-3" id="idEstado" name="idEstado" type="hidden" placeholder="" value="<%=estado.getIdEstado()%>" disabled />
                                                <input class="form-control py-3" id="estado" name="estado" type="text" placeholder="" onkeypress="return apenasLetras(event);" value="<%=estado.getDescricaoEstado()%>" />
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="uf" name="uf" type="text" placeholder="" value="<%=estado.getUfEstado()%>" />
                                            </div>
                                        </div>
