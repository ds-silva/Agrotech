        ...
        <script>
            $(document).ready(function () {
                $("#excluir").click(function () {
                    ...
                    var idNacionalidade_digitado = $("#idNacionalidade").val();

                    $.ajax(
                            {
                                url: "excluirNacionalidade?" +
                                        "idNacionalidade=" + idNacionalidade_digitado,
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Resultado de Consulta de País</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="consultar_nac.jsp">Consultar</a></li>
                        <li class="breadcrumb-item"><a href="li_consulta_nac.jsp">Listagem de Consulta</a></li>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="resultadoConsNacionalidade" method="post">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <%
                                                Nacionalidade n = (Nacionalidade) request.getAttribute("nac");
                                            %>

                                            <input class="form-control py-3" id="idNacionalidade" name="idNacionalidade" type="hidden" placeholder="" value="<%=n.getIdNacionalidade()%>" disabled/>
                                            <input class="form-control py-3" id="pais" name="pais" type="text" placeholder="" value="<%=n.getDescricaoNacionalidade()%>" disabled/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="small mb-1.1" for="sigla">Sigla</label>                     
                                            <input class="form-control py-3" id="sigla" name="sigla" type="text" placeholder="" value="<%=n.getSiglaNacionalidade()%>" disabled/>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="form-group mt-4 mb-0"><a href="alterarNacionalidade?id=<%=n.getIdNacionalidade()%>" class="btn btn-warning btn-block text-light" role="button">Alterar</a></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-content">
                                            <form>
                                                ...
                                                <div class="modal-body">					
                                                    <p>Tem certeza que deseja <strong>apagar</strong> esse País?</p>
                                ...
                                <div id="DisableEmployeeModal" class="modal fade">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form>
                                                <div class="modal-header">						
                                                    <h4 class="modal-title">Desabilitar País</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                </div>
                                                <div class="modal-body">					
                                                    <p>Tem certeza que deseja <strong>alterar o status</strong> desse País?</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">Cancelar</button>
                                                    <%
