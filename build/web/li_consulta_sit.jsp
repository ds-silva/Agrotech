...
<html>
    <head>
        ...
        <title>Listagem de Consulta de Situação de Usuário</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Listagem de Consultar Situação de Usuário</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="consultar_sit.jsp">Consulta</a></li>
                                ...
                                <div class="container">
                                    <div class="table-wrapper">
                                        ...
                                        <table class="table table-striped table-hover">
                                           ...
                                           <%
                                                    List<Usuario> SitUsu=(ArrayList<Usuario>) session.getAttribute("listaSituacaoUsuario"); 
                                                    for (Usuario u: SitUsu) {   
                                                    %>
                                                        <tr data-href="#">
                                                            <td><a href="consultarSituacaoUsuarioResultado?id=<%=u.getIdSituacaoUsuario()%>"><%=u.getDescSituacaoUsuario()%></a></td>
                                                            <td><a href="consultarSituacaoUsuarioResultado?id=<%=u.getIdSituacaoUsuario()%>"><%=u.getDesabilitardescSituacaoUsuario()%></a></td>
                                                        </tr>
                                                    <%}%>
                                            </tbody>
                                        </table>
