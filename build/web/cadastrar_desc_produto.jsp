...
<html lang="pt-br">
    <head>
        ...
        <title>Cadastrar Descrição de Produto</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Cadastrar Descrição de Produtos</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item active">Cadastrar Descrição de Produtos</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" name="nomeProduto" id="nomeProduto" type="text" placeholder="Digite o produto" value=""/>                                          
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" name="unidadeProduto" id="unidadeProduto" type="text" placeholder="Digite a unidade" value=""/>
                                            </div>
                                        </div>
                                    </div>
