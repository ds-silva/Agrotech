        ...
        <script>
            $(document).ready(function() {
                $("#cadastrar").click(function() {
                    ...
                    $.ajax(
                        {
                            url: "cadastrarNacionalidade?"+
                            "pais="+pais_digitado+
                            "&sigla="+sigla_digitada,
                            contentType: "charset=UTF-8",
                            success: function(retorno) {
                                if (retorno.trim()=="ok") {
                                    location.replace("mensagem_cadastrar_interno.jsp");  //sucesso
                                    } 
                                    else {
                                        //erro
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Cadastrar País</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item active">Cadastrar País</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="pais" name="pais" type="text" onkeypress="return apenasLetras(event);"  value="" placeholder="Digite o país" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="sigla" name="sigla" onkeypress="return apenasLetras(event);"  value="" type="text" placeholder="Digite a sigla" />
                                            </div>
                                        </div>
