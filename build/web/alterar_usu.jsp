    ...
    <body>
       ...
       <div id="layoutSidenav">
        <div id="layoutSidenav_nav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Alterar Usuário</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="consultar_usu.jsp">Consultar Usuário</a></li>
                                ...
                                <form action="alterarUsu" method="post">
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-2">    
                                         ...
                                         <div class="col-md-2">
                                            <div class="form-group">
                                                <label class="small mb-1" >Situação do Usuário</label>
                                    ...
                                    <div class="form-row">  
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="orgaoDocumento" name="orgaoDocumento" type="text" placeholder="" value=""/>
                                            </div>
                                        </div>
                                        <div class="col-md-3"></div> 
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-1," style="display : flex; justify-content : center; align-items : center; flex-direction : initial;">
                                            ...
                                            <div class="form-group mt-4 mb-0"><button class="btn btn-success btn-block" type="submit" onclick="return validar()">Salvar Alterações</button></div>
            ...
            <scrip  src="js/buscadorcep.js"></script>
