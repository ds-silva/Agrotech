    ...
    <head>
        ...
        <script>
            $(document).ready(function() {
               ...
               var numeroDocumento_digitado = $("#numeroCpfCnpjUsuario").val();
               var sexo_digitado = $("#sexo").val(); 
               var nascimento_digitado = $("#nascimentoUsuario").val(); 
               ...
               $.ajax(
                   {
                       ...
                       "&numeroCpfCnpjUsuario="+numeroDocumento_digitado+
                       "&sexo="+sexo_digitado+
                       "&nascimentoUsuario="+nascimento_digitado+
                       ...
                       success: function(retorno) {
                           if (retorno.trim()=="ok") {
                               //sucesso
                               location.replace("mensagem_cadastrar_livre.jsp");
                               } 
                               else {
                                   //erro
    ...
    <body>
        ...
        <div class="card mb-4 mt-4">
            <div class="card-body">
                ...
                <h3 class="text-center font-weight-light mt-2 my-0">Cadastro de Proprietário</h3>
                ...
                <form action="#" method="#">
                    ...
                    <h6 class="text-justify lead text-center" style="font-size: 10px; font-weight: bolder;"><br>REPITA O DOCUMENTO CASO NECESSÁRIO
                        <span data-toggle="tooltip" data-placement="right" title="Mesmo que um documento esteja inserido dentro de outro, como o CPF no RG, Ã© necessÃ¡rio uma foto para cada documento">[&#63;]</span>                                
                        <br><br></h6>
