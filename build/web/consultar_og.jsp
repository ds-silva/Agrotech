...
<html lang="pt-br">
    <head>
        ...
        <title>Consultar Órgão Funcional</title>
        ...
        <script>
            $(document).ready(function() {
                $("#consultar").click(function() {
                    ...
                    $.ajax(
                        {
                            url: "consultarOrgaoFuncional?"+
                            "orgaoFuncional="+orgaoFuncional_digitado,
                            contentType: "charset=UTF-8",
                            success: function(retorno) {
                                if (retorno=="ok") {
                                    location.replace("li_consulta_og.jsp");  //sucesso
                                    } 
                                    else {
                                        //erro
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Consultar Órgão Funcional</h1>
                                ...
                                <form action="#" method="#">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="orgaoFuncional" value="" name="orgaoFuncional" type="text" placeholder="Digite o órgão" />
                                            </div>                                            
                                         </div>
