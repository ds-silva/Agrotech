                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form action="#" method="#">
                                    ...
                                    <div class="form-row"><div class="col-md-3"></div><h5 class="font-weight-light my-4">Dados do Funcionário</h5></div>
                                    <%                                
                                Usuario user = (Usuario) session.getAttribute("userInfos");
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="orgaoDocumento" name="orgaoDocumento" type="text" placeholder="Digite o órgão" value="<%=user.getOrgaoExpedidorRgRne()%>"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="numeroEndereco" name="numeroEndereco" type="text" placeholder="Nº do local" value="<%=user.getEndereco().getNumero()%>" />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                    ...
                                    <div class="form-row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group mt-4 mb-6"><button class="btn btn-success btn-block" id="salvar">Salvar Alterações</button></div>
                                            </div>    

                                        </div>

                                        <!-- <div class="form-group mt-4 mb-0"><button class="btn btn-success btn-block" data-toggle="modal" data-target="#perfilModal">Salvar Alterações</button></div> -->
                                ...
                                <div id="myModal" class="modal fade" tabindex="-1" role="dialog">
                                     ...
                                     <!-- Central Modal Medium Success -->
                                        ...
                                        <div class="modal-content">
                                            <!--Header-->
                                            <div class="modal-header">
                                            <p class="heading lead">Alterações de dados</p>
