                    ...
                    $.ajax(
                        {
                            ...
                            success: function(retorno) {
                                if (retorno.trim()=="ok") {
                                   location.replace("li_consulta_proprietario.jsp");  //sucesso 
                                    } else {
                                       //erro
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Consultar Proprietário</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item active">Consultar Proprietário</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
