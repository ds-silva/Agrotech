...
<html lang="pt-br">
    <head>
        ...
        <title>Cadastrar Situação Imóvel Rural</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Cadastrar Situação Imóvel Rural</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item active">Cadastrar Situação Imóvel Rural</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="situacaoImovelRural" name="situacaoImovelRural" type="text" placeholder="Digite a situação" value=""/>
                                            </div>
                                        </div>
