...
<html lang="pt-br">
    <head>
        ...
        <title>Alterar Órgão Funcional</title>
        ...
        <script>
            $(document).ready(function() {
                $("#salvarAlteracoes").click(function() {
                    ...
                    var idOrgaoFuncional = $("#idOrgaoFuncional").val();

                    $.ajax(
                        {
                            url: "alterarOrgaoFuncionalResultado?"+
                            "orgaoFuncional="+orgaoFuncional_digitado+
                            "&idOrgaoFuncional="+idOrgaoFuncional,
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Alterar Órgão Funcional</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="consultar_og.jsp">Consultar Órgão Funcional</a></li>
                            <li class="breadcrumb-item"><a href="li_consulta_og.jsp">Listagem de Consulta</a></li>
                            <li class="breadcrumb-item"><a href="resultado_cons_og.jsp">Resultado Consulta</a></li>
                            <li class="breadcrumb-item active">Alterar Órgão Funcional</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form action="#" method="#">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <%
                                                    Regional oG = (Regional) request.getAttribute("og");
                                                %>
                                                ...
                                                <input class="form-control py-3" id="orgaoFuncional" name="orgaoFuncional" type="text" placeholder="" value="<%=oG.getOrgaoFuncional()%>"/>
                                            </div>                                            
                                         </div>
