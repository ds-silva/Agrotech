...
<html lang="pt-br">
    <head>
        ...
        <title>Consultar Situação Imóvel Rural</title>
        ...
        <script>
            $(document).ready(function(){
                $("#consultar").click(function(){
                    ...
                    $.ajax(
                        {
                            url:"consultarSituacaoImovel?"+
                                "situacaoImovelRural="+situacaoImovelRural,
                                contentType: "charset=UTF-8",
                                success: function(retorno){
                                if (retorno=="ok") {
                                   location.replace("li_consulta_sit_ir.jsp");  //successo
                                } else{
                                    //erro
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Consultar Situação Imóvel Rural</h1>
