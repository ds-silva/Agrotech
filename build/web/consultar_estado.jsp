			        ...
			        $.ajax(
			            {  
                            ...
                            success: function(retorno) {
                                if(retorno=="ok") {
                                   location.replace("li_consulta_estado.jsp");  //sucesso
                                } else {
                                    //erro
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Consultar Estado</h1>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="estado" name="estado" type="text" placeholder="Nome do estado" onkeypress="return apenasLetras(event);" value="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="uf"  name="uf" type="text" placeholder="Digite a sigla" value=""/>
                                            </div>
                                        </div>
