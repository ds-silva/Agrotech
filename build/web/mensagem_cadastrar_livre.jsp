                    ...
                    <div id="layoutAuthentication">
                        ...
                        <div id="layoutAuthentication_content">
                            ...
                            <div class="text-center">
                                    ...
                                    <h1 style="text-align: center; font-size: 22px; padding-top: 5%;">Cadastro realizado com sucesso!</h1>
                                    <h1 style="text-align: center; font-size: 22px; padding-top: 1%;">Realize o acesso com seu CPF ou CNPJ em nosso site e realize o cadastro de pelo menos um imóvel rural.<br> Enquanto isso os dados do seu cadastro serão avaliados, aguarde a validação! </h1>

                                    <div class="col-md-2," style="display : flex; justify-content : center; align-items : center; flex-direction : initial;">
                                                                    
                                        <a href="index.jsp" class="form-group mt-4 mb-0"><button class="btn btn-success btn-block">Voltar ao Início</button></a>
