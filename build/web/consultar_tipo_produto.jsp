...
<html lang="pt-br">
    <head>
        ...
        <title>Consultar Tipo de Produto</title>
            ...
            $(document).ready(function() {
                $("#consultar").click(function() {
                   event.preventDefault();
                    ...
                    $.ajax(
                        {
                            url: "consultarTipoProduto?"+
                            "tipoProduto="+_tipoProduto,    
                            contentType: "charset=UTF-8",
                            success: function(retorno) {
                                if (retorno=="ok") {
                                    location.replace("li_consulta_tipo_produto.jsp");  //sucesso //sucesso
                                    } else {
                                        //erro
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Consultar Tipo de Produto</h1>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="tipoProduto" name="tipoProduto" type="text" placeholder="Digite o tipo" value=""/>
                                            </div>
                                        </div>
