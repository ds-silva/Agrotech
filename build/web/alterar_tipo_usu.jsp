        ...
        <script>
            $(document).ready(function() {
                $("#salvarAlteracoes").click(function() {
                    ...
                    var usuarioTipo = $("#tipoUsuario").val();
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Alterar Tipo de Usuário</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="consultar_tipo_usu.jsp">Consultar Tipo de Usuário</a></li>
                            <li class="breadcrumb-item"><a href="li_consulta_tipo_usu.jsp">Listagem de Consulta</a></li>
                            <li class="breadcrumb-item"><a href="resultado_cons_tipo_usu.jsp">Resultado Consulta</a></li>
                            <li class="breadcrumb-item active">Alterar Tipo de Usuário</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="tipoUsuario" name="tipoUsuario" type="text" placeholder="Digite o tipo" value=""/>
                                            </div>
                                        </div>
