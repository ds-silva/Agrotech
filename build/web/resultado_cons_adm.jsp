    ...
    <head>
        ...
        $(document).ready(function() {
            $("#excluir").click(function() {
                ...
                var idNomedigitado = $("#idAdministrador").val();


                $.ajax(
                    {
                        url: "excluirAdministrador?"+
                        "idAdministrador="+idNomedigitado,
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Resultado de Consulta de Administrador</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="consultar_adm.jsp">Consultar</a></li>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form action="#" method="post">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                %>
                                                <input class="form-control py-3" id="idAdministrador" name="idAdministrador" type="hidden" placeholder="" value="<%=adm.getIdUsuario()%>" disabled/>
                                                <input class="form-control py-3" id="nomeUsuario" name="nomeUsuario" type="text" placeholder="Digite seu Nome" value="<%=adm.getNome()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="sobrenomeUsuario" name="sobrenomeUsuario" type="text" placeholder="Digite seu Sobrenome" value="<%=adm.getSobrenome()%>" disabled/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="emailUsuario" name="emailUsuario" type="email" placeholder="Digite seu Email" value="<%=adm.getEmail()%>" disabled/>
                                            </div>   
                                        </div>
                                        ...
                                        <div class="col-md-2">    
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="matriculaUsuario" name="matriculaUsuario" type="text" placeholder="Apenas Números" value="<%=adm.getMatricula()%>" disabled/>
                                            </div>                                 
                                         </div>
                                         <div class="col-md-3">    </div>
                                    </div>
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3 " id="naturalizacaoDocumento" name="naturalizacaoDocumento" type="text" value="<%=adm.getRgRne()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="orgaoDocumento" name="orgaoDocumento" type="text" placeholder="" value="<%=adm.getOrgaoExpedidorRgRne()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="emissaoDocumento" name="emissaoDocumento" type="date" placeholder="dd/mm/aaaa" value="<%=adm.getDataEmissaoRgRne()%>" disabled/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row"> 
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3 " id="numeroCpfCnpjUsuario" name="numeroCpfCnpjUsuario" type="text" value="<%=adm.getCpfCnpj()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group" Style="height: 38px;">                                            
                                                ...
                                                <select id="sexo" name="sexo" class="form-control" disabled>
                                                    <option value=""><%=adm.getSexo()%></option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="nascimentoUsuario" name="nascimentoUsuario" type="date" placeholder="dd/mm/aaaa" value="<%=adm.getDataNascimento()%>" disabled/>
                                            </div>
                                        </div> 
                                    </div>
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group" >                                            
                                                ...
                                                <select id="orgaoFuncional" name="orgaoFuncional" class="form-control" disabled>
                                                    <option value=""><%=adm.getRegional().getOrgaoFuncional()%></option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="regional" name="regional" type="text" placeholder="Regional" value="<%=adm.getRegional().getDescricaoRegional()%>" disabled/>
                                            </div>
                                        </div>
                                    ...
                                    <%
                                        for (Telefone t : adm.getTelefones()) {
                                    %>
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="cep" name="cep" type="text" onblur="pesquisacep(this.value);" value="<%=adm.getEndereco().getCep()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="tipoLogradouro" name="tipoLogradouro" type="text" placeholder="Tipo de Logradouro" value="<%=adm.getEndereco().getTipoLogradouro()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="logradouro" name="logradouro" type="text" placeholder="Nome do Logradouro" value="<%=adm.getEndereco().getLogradouro()%>" disabled/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="numeroEndereco" name="numeroEndereco" type="text" placeholder="Nº do Local" value="<%=adm.getEndereco().getNumero()%>" disabled/>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label class="small mb-1" for="complemento">Complemento</label>
                                                <input class="form-control py-3" id="complemento" name="complemento" type="text" placeholder="Complemento" value="<%=adm.getEndereco().getComplemento()%>" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="bairro" name="bairro" type="text" placeholder="Bairro" value="<%=adm.getEndereco().getBairro()%>" disabled/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">    
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-3" id="cidade" name="cidade" type="text" placeholder="Cidade" value="<%=adm.getEndereco().getCidade()%>" disabled/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="form-group mt-4 mb-0"><a href="alterarAdministrador?id=<%=adm.getIdUsuario()%>"><button class="btn btn-warning btn-block text-light">Alterar</button></a></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <%
                                                    if (adm.getDesabilitarUsuario() == true) {
                                                %>
